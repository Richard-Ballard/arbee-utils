...
import org.arbee.arbeeutils.numeric.Count;
...
public class TimeBoundAttempter<T> {
    ...
    @NotNull
    private final Consumer<? super OperationWithAttemptCount<T>> attemptFailedConsumer;

    @NotNull
    private final Function<? super OperationWithAttemptCount<T>, ? extends T> allAttemptsFailedFunction;
    ...
    public TimeBoundAttempter(@NotNull final Duration maxOperationDuration,
                              ...
                              @NotNull final Consumer<? super OperationWithAttemptCount<T>> attemptFailedConsumer,
                              @NotNull final Function<? super OperationWithAttemptCount<T>, ? extends T> allAttemptsFailedFunction) {
     ...
     */
    public T performOperation(@NotNull final Supplier<? extends T> operation) {
    ...
    public static class OperationWithAttemptCount<T> {
        @NotNull
        private final Supplier<? extends T> operation;

        @NotNull
        private final Count attemptCount;

        public OperationWithAttemptCount(@NotNull final Supplier<? extends T> operation,
        ...
        @NotNull
        public Supplier<? extends T> getOperation() {
            return operation;
        }
